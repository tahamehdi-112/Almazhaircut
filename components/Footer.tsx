      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-24">
          ...
          <div className="flex flex-col items-start md:items-end text-left md:text-right space-y-8">
            ...
            <a href="https://maps.app.goo.gl/kenmBggtubyK8gZz6" className="inline-block bg-white text-black hover:bg-gray-200 transition-colors px-6 py-2 text-xs font-bold uppercase tracking-widest">
              ROUTE STARTEN
            </a>
          </div>
